...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"Others/DS/Practice Pattern/index 23.6.js":[function(require,module,exports) {
...
function checkFreq(arr1, arr2) {
  ...
  for (var i = 0; i < arr1.length; i++) {
    var squre = arr1[i] * arr1[i];
    var index = arr2.indexOf(squre);
...
function isCheckFrequency(arr1, arr2) {
  ...
  var _iterator2 = _createForOfIteratorHelper(arr2),
      _step2;
  ...
  for (var value in obj1) {
    if (!(Math.pow(value, 2) in obj2)) {
      return false;
    }

    var squre = value * value;
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","Others/DS/Practice Pattern/index 23.6.js"], null)
//# sourceMappingURL=/index%2023.6.5d9c2ec1.js.map
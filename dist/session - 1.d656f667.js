...
var _require = require('rxjs'),
    async = _require.async; // // function hello() {
// //   setTimeout(function () {
// //     console.log('hello');
...
var data = checkData(); // console.log(data.then((res) => console.log(res)));
...
var p1 = new Person('ndf', 'Er'); // p1.getData();

Array.prototype.display = function () {
  console.log(this.toString());
};

var numberArr = [1, 34, 55, 31, 343];
numberArr.display(); // console.log(numberArr);
...
var cloneObje = JSON.parse(JSON.stringify(obj)); // newObj.a.b.c = 10;
...
function uniqueChar(str) {
  ...
  for (var char in obj) {
    if (obj[char] === 1) {
      var indexChar = str.indexOf(char);
      return {
        char: char,
        indexChar: indexChar
      };
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","IC Practice/wellCome/session - 1.js"], null)
//# sourceMappingURL=/session%20-%201.d656f667.js.map
...
function getInfo(args) {
  ...
  (_console = console).log.apply(_console, [this.city, ' ', this.state].concat(_toConsumableArray(args)));
}

var bindData = getInfo.bind(student, ['UMBC', 'DownTown', 'Hiltop']);
bindData(); // Object seal , freez , clone
...
var cityInfo2 = _objectSpread({}, cityInfo);

var cityInfo3 = JSON.parse(JSON.stringify(cityInfo));
